...
class TencentProvider(BaseProvider):
    ...
    def get_balance(self, config: dict) -> BalanceInfo:
        ...
        result = self._get(
            "https://console.tencentcloud.com/tokenhub/api/balance",
            headers=headers
        )
    ...
    def get_plans(self, config: dict) -> List[PlanInfo]:
        ...
        result = self._get(
            "https://console.tencentcloud.com/tokenhub/api/token-plan/usage",
            headers=headers
        )
    ...
    def get_cookie_login_url(self) -> str:
        return "https://console.tencentcloud.com/tokenhub"
